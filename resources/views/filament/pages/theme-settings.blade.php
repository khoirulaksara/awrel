<x-filament-panels::page>
    ...
    {{--
    ================================================================
    Awrel Theme Settings — Tabbed Layout
    ================================================================
    --}}

    <form wire:submit="save" x-data="awrelSettingsTabs()">

        {{-- Tab Navigation --}}
        <div class="sticky top-0 z-20 -mx-4 -mt-6 mb-6 border-b border-gray-200 bg-white/90 px-4 pb-0 pt-4 backdrop-blur dark:border-gray-700/50 dark:bg-gray-900/90 sm:-mx-6 sm:px-6 lg:-mx-8 lg:px-8">
            <nav class="flex gap-1 overflow-x-auto" role="tablist">
                <button type="button" role="tab" x-on:click="switchTab('general')"
                    :class="activeTab === 'general' ? 'border-primary-500 text-primary-600 dark:text-primary-400' : 'border-transparent text-gray-500 hover:border-gray-300 hover:text-gray-700 dark:hover:border-gray-600 dark:hover:text-gray-300'"
                ...
                <button type="button" role="tab" x-on:click="switchTab('branding')"
                    :class="activeTab === 'branding' ? 'border-primary-500 text-primary-600 dark:text-primary-400' : 'border-transparent text-gray-500 hover:border-gray-300 hover:text-gray-700 dark:hover:border-gray-600 dark:hover:text-gray-300'"
                    class="flex shrink-0 items-center gap-2 border-b-2 px-4 py-3 text-sm font-medium transition-all duration-150 whitespace-nowrap">
                ...
                <button type="button" role="tab" x-on:click="switchTab('login')"
                    :class="activeTab === 'login' ? 'border-primary-500 text-primary-600 dark:text-primary-400' : 'border-transparent text-gray-500 hover:border-gray-300 hover:text-gray-700 dark:hover:border-gray-600 dark:hover:text-gray-300'"
                    class="flex shrink-0 items-center gap-2 border-b-2 px-4 py-3 text-sm font-medium transition-all duration-150 whitespace-nowrap">
                    <x-heroicon-m-lock-closed class="h-4 w-4" />
                    <span class="hidden sm:inline">Login</span>
                </button>
                <button type="button" role="tab" x-on:click="switchTab('layout')"
                    :class="activeTab === 'layout' ? 'border-primary-500 text-primary-600 dark:text-primary-400' : 'border-transparent text-gray-500 hover:border-gray-300 hover:text-gray-700 dark:hover:border-gray-600 dark:hover:text-gray-300'"
                    class="flex shrink-0 items-center gap-2 border-b-2 px-4 py-3 text-sm font-medium transition-all duration-150 whitespace-nowrap">
        ...
        {{--  1. General Tab                                                   --}}
        {{-- ================================================================ --}}
        <div x-show="activeTab === 'general'" x-transition:enter.duration.200ms.opacity class="space-y-6">
        ...
        {{--  2. Branding Tab                                                  --}}
        {{-- ================================================================ --}}
        <div x-show="activeTab === 'branding'" x-transition:enter.duration.200ms.opacity class="space-y-6">
            <div class="rounded-2xl border border-gray-200 bg-white shadow-sm dark:border-gray-700/50 dark:bg-gray-900">
                <div class="border-b border-gray-100 px-6 py-4 dark:border-gray-800">
                    <div class="flex items-center gap-3">
                        <span class="flex h-8 w-8 items-center justify-center rounded-lg bg-primary-50 text-primary-600 dark:bg-primary-900/50 dark:text-primary-400">
        ...
        {{--  5. Login Page Tab                                               --}}
        {{-- ================================================================ --}}
        <div x-show="activeTab === 'login'" x-transition:enter.duration.200ms.opacity class="space-y-6">
            <div class="rounded-2xl border border-gray-200 bg-white shadow-sm dark:border-gray-700/50 dark:bg-gray-900">
                <div class="border-b border-gray-100 px-6 py-4 dark:border-gray-800">
                    <div class="flex items-center gap-3">
                        <span class="flex h-8 w-8 items-center justify-center rounded-lg bg-primary-50 text-primary-600 dark:bg-primary-900/50 dark:text-primary-400">
        ...
        {{--  6. Layout Tab                                                   --}}
        {{-- ================================================================ --}}
        <div x-show="activeTab === 'layout'" x-transition:enter.duration.200ms.opacity class="space-y-6">
            <div class="rounded-2xl border border-gray-200 bg-white shadow-sm dark:border-gray-700/50 dark:bg-gray-900">
                <div class="border-b border-gray-100 px-6 py-4 dark:border-gray-800">
                    <div class="flex items-center gap-3">
                        <span class="flex h-8 w-8 items-center justify-center rounded-lg bg-primary-50 text-primary-600 dark:bg-primary-900/50 dark:text-primary-400">
        ...
        {{-- ================================================================ --}}
        <div class="sticky bottom-0 z-10 -mx-4 -mb-4 mt-6 rounded-b-2xl border-t border-gray-200 bg-white/80 px-4 py-4 backdrop-blur dark:border-gray-700/50 dark:bg-gray-900/80 sm:-mx-6 sm:px-6 lg:-mx-8 lg:px-8">
